...
console.log("2"=== 2); //VSince the operands are of different types (string vs. number), the strict equality operator returns false without converting or coercing the types.
